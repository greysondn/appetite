...
def format(ctx: Context):
    ...
    match platform.system():
        case ("Windows"):
            ...
            # TODO: That powershell command is just a dumb find-replace. I can
            #       theoretically write a limited function formatter that just
            #       replaces some things to supplement YAPF, but that requires
            #       per-version maintenance. So. That's a bloody nightmare that
            #       I need to engage in for robust formatting.
        case _:
            print(f"Running on unimplemented platform:{platform.system()}")
